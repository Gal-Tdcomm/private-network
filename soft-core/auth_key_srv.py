...
def main():
    ...
    server_ini = config['ext_proc_server']

    G_LOGGER.info(
        "Created HTTP server listening on port %s:%s. Waiting for Auth Vector requests to /%s from Ext Proc ...",
